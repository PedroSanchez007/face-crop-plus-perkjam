...
def parse_args() -> dict[str, Any]:
    ...
    parser.add_argument(
        "-cm", "--crop-mode", type=str, default="bbox",
    ...
    parser.add_argument(
        "-etop", "--expansion_top", type=float, default=0.5,
        help="Fraction of the bounding box height to expand upward (default: 0.5)."
    )
    parser.add_argument(
        "-ebottom", "--expansion_bottom", type=float, default=0.2,
        help="Fraction of the bounding box height to expand downward (default: 0.2)."
    )
    parser.add_argument(
        "-eleft", "--expansion_left", type=float, default=0.3,
        help="Fraction of the bounding box width to expand leftward (default: 0.3)."
    )
    parser.add_argument(
        "-eright", "--expansion_right", type=float, default=0.3,
        help="Fraction of the bounding box width to expand rightward (default: 0.3)."
    )
